...
| ------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| 에란겔 | 차고지17·고정차량41·고정보트23·비밀의방15·**글라이더40**·주유소0               | 글라이더 빼고 전부 확보                                                                                            |
| 미라마 | 고정보트10·비밀의방13·**글라이더40**·황금미라도2·e스포츠미라도20·e스포츠픽업20 | 글라이더 없음. 고정차량/차고지는 BGMS도 일반전 카테고리가 없어(e스포츠 룰셋만 있음) 텍스트 출처 유지 중            |
| 론도   | 차고지6·고정차량11·비밀의방15·**글라이더10**·**주유소17**                      | 글라이더·주유소 없음. **주유소는 다른 맵엔 0인데 론도만 17개 — 42.2 개편 때 생긴 신규 메커닉일 가능성, 확인 필요** |
| 태이고 | 차고지24·포터24(=차고지와 동일세트로 추정)·비밀의방15, 나머지 전부 0           | 전부 확보, 갭 없음                                                                                                 |

**신규로 만들어야 할 레이어**: `GLIDER`(모터글라이더, 에란겔/미라마/론도), `GAS_STATION`(주유소,
론도만 — 성격 파악 먼저 필요, 급유 메커닉인지 단순 랜드마크인지).
...
- [ ] `GLIDER`(글라이더) 레이어 신규 추가 — 에란겔40/미라마40/론도10, 스키마+아이콘+색상+토글
- [ ] `GAS_STATION`(주유소) 레이어 검토 — 론도에만 17개, 42.2 신규 메커닉인지 먼저 확인 후
      레이어 추가 여부 결정
